...
static asn_SET_OF_specifics_t asn_SPC_hnbConfigTransferResponse_ies_specs_2 = {
	sizeof(struct HNBAP_HNBConfigTransferResponse__hnbConfigTransferResponse_ies),
	offsetof(struct HNBAP_HNBConfigTransferResponse__hnbConfigTransferResponse_ies, _asn_ctx),
