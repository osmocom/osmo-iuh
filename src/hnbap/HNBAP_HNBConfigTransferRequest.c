...
static asn_SET_OF_specifics_t asn_SPC_hnbConfigTransferRequest_ies_specs_2 = {
	sizeof(struct HNBAP_HNBConfigTransferRequest__hnbConfigTransferRequest_ies),
	offsetof(struct HNBAP_HNBConfigTransferRequest__hnbConfigTransferRequest_ies, _asn_ctx),
