...
static asn_TYPE_member_t asn_MBR_ipaddress_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct HNBAP_IP_Address__ipaddress, choice.ipv4info),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct HNBAP_IP_Address__ipaddress, choice.ipv6info),
...
static asn_CHOICE_specifics_t asn_SPC_ipaddress_specs_2 = {
	...
	offsetof(struct HNBAP_IP_Address__ipaddress, _asn_ctx),
	offsetof(struct HNBAP_IP_Address__ipaddress, present),
	sizeof(((struct HNBAP_IP_Address__ipaddress *)0)->present),
