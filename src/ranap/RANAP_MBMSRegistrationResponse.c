...
static asn_SET_OF_specifics_t asn_SPC_mbmsRegistrationResponse_ies_specs_2 = {
	sizeof(struct RANAP_MBMSRegistrationResponse__mbmsRegistrationResponse_ies),
	offsetof(struct RANAP_MBMSRegistrationResponse__mbmsRegistrationResponse_ies, _asn_ctx),
