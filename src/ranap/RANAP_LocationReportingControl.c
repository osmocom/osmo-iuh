...
static asn_SET_OF_specifics_t asn_SPC_locationReportingControl_ies_specs_2 = {
	sizeof(struct RANAP_LocationReportingControl__locationReportingControl_ies),
	offsetof(struct RANAP_LocationReportingControl__locationReportingControl_ies, _asn_ctx),
