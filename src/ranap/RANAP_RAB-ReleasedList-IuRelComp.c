...
static asn_SET_OF_specifics_t asn_SPC_raB_ReleasedList_IuRelComp_ies_specs_2 = {
	sizeof(struct RANAP_RAB_ReleasedList_IuRelComp__raB_ReleasedList_IuRelComp_ies),
	offsetof(struct RANAP_RAB_ReleasedList_IuRelComp__raB_ReleasedList_IuRelComp_ies, _asn_ctx),
