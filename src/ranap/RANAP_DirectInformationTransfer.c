...
static asn_SET_OF_specifics_t asn_SPC_directInformationTransfer_ies_specs_2 = {
	sizeof(struct RANAP_DirectInformationTransfer__directInformationTransfer_ies),
	offsetof(struct RANAP_DirectInformationTransfer__directInformationTransfer_ies, _asn_ctx),
