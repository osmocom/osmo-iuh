...
static asn_SET_OF_specifics_t asn_SPC_raBs_failed_to_reportList_ies_specs_2 = {
	sizeof(struct RANAP_RABs_failed_to_reportList__raBs_failed_to_reportList_ies),
	offsetof(struct RANAP_RABs_failed_to_reportList__raBs_failed_to_reportList_ies, _asn_ctx),
