...
static asn_SET_OF_specifics_t asn_SPC_raB_SetupList_EnhRelocInfoReq_ies_specs_2 = {
	sizeof(struct RANAP_RAB_SetupList_EnhRelocInfoReq__raB_SetupList_EnhRelocInfoReq_ies),
	offsetof(struct RANAP_RAB_SetupList_EnhRelocInfoReq__raB_SetupList_EnhRelocInfoReq_ies, _asn_ctx),
