...
static asn_SET_OF_specifics_t asn_SPC_informationTransferConfirmation_ies_specs_2 = {
	sizeof(struct RANAP_InformationTransferConfirmation__informationTransferConfirmation_ies),
	offsetof(struct RANAP_InformationTransferConfirmation__informationTransferConfirmation_ies, _asn_ctx),
