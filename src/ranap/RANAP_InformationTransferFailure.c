...
static asn_SET_OF_specifics_t asn_SPC_informationTransferFailure_ies_specs_2 = {
	sizeof(struct RANAP_InformationTransferFailure__informationTransferFailure_ies),
	offsetof(struct RANAP_InformationTransferFailure__informationTransferFailure_ies, _asn_ctx),
