...
static asn_SET_OF_specifics_t asn_SPC_enhancedRelocationCompleteRequest_ies_specs_2 = {
	sizeof(struct RANAP_EnhancedRelocationCompleteRequest__enhancedRelocationCompleteRequest_ies),
	offsetof(struct RANAP_EnhancedRelocationCompleteRequest__enhancedRelocationCompleteRequest_ies, _asn_ctx),
