...
static asn_SET_OF_specifics_t asn_SPC_uplinkInformationExchangeResponse_ies_specs_2 = {
	sizeof(struct RANAP_UplinkInformationExchangeResponse__uplinkInformationExchangeResponse_ies),
	offsetof(struct RANAP_UplinkInformationExchangeResponse__uplinkInformationExchangeResponse_ies, _asn_ctx),
