...
static asn_SET_OF_specifics_t asn_SPC_enhancedRelocationCompleteResponse_ies_specs_2 = {
	sizeof(struct RANAP_EnhancedRelocationCompleteResponse__enhancedRelocationCompleteResponse_ies),
	offsetof(struct RANAP_EnhancedRelocationCompleteResponse__enhancedRelocationCompleteResponse_ies, _asn_ctx),
