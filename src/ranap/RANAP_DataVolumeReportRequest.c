...
static asn_SET_OF_specifics_t asn_SPC_dataVolumeReportRequest_ies_specs_2 = {
	sizeof(struct RANAP_DataVolumeReportRequest__dataVolumeReportRequest_ies),
	offsetof(struct RANAP_DataVolumeReportRequest__dataVolumeReportRequest_ies, _asn_ctx),
