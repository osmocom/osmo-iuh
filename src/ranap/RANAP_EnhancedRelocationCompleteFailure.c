...
static asn_SET_OF_specifics_t asn_SPC_enhancedRelocationCompleteFailure_ies_specs_2 = {
	sizeof(struct RANAP_EnhancedRelocationCompleteFailure__enhancedRelocationCompleteFailure_ies),
	offsetof(struct RANAP_EnhancedRelocationCompleteFailure__enhancedRelocationCompleteFailure_ies, _asn_ctx),
