...
static asn_SET_OF_specifics_t asn_SPC_uplinkInformationExchangeRequest_ies_specs_2 = {
	sizeof(struct RANAP_UplinkInformationExchangeRequest__uplinkInformationExchangeRequest_ies),
	offsetof(struct RANAP_UplinkInformationExchangeRequest__uplinkInformationExchangeRequest_ies, _asn_ctx),
