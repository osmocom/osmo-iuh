...
static asn_SET_OF_specifics_t asn_SPC_geraN_Iumode_RAB_Failed_RABAssgntResponse_List_ies_specs_2 = {
	sizeof(struct RANAP_GERAN_Iumode_RAB_Failed_RABAssgntResponse_List__geraN_Iumode_RAB_Failed_RABAssgntResponse_List_ies),
	offsetof(struct RANAP_GERAN_Iumode_RAB_Failed_RABAssgntResponse_List__geraN_Iumode_RAB_Failed_RABAssgntResponse_List_ies, _asn_ctx),
