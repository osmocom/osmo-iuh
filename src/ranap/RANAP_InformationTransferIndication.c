...
static asn_SET_OF_specifics_t asn_SPC_informationTransferIndication_ies_specs_2 = {
	sizeof(struct RANAP_InformationTransferIndication__informationTransferIndication_ies),
	offsetof(struct RANAP_InformationTransferIndication__informationTransferIndication_ies, _asn_ctx),
