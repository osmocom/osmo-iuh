...
static asn_SET_OF_specifics_t asn_SPC_locationRelatedDataFailure_ies_specs_2 = {
	sizeof(struct RANAP_LocationRelatedDataFailure__locationRelatedDataFailure_ies),
	offsetof(struct RANAP_LocationRelatedDataFailure__locationRelatedDataFailure_ies, _asn_ctx),
