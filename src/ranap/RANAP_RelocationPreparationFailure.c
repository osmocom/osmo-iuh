...
static asn_SET_OF_specifics_t asn_SPC_relocationPreparationFailure_ies_specs_2 = {
	sizeof(struct RANAP_RelocationPreparationFailure__relocationPreparationFailure_ies),
	offsetof(struct RANAP_RelocationPreparationFailure__relocationPreparationFailure_ies, _asn_ctx),
