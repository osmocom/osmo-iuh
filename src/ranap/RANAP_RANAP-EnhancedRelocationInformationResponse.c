...
static asn_SET_OF_specifics_t asn_SPC_ranaP_EnhancedRelocationInformationResponse_ies_specs_2 = {
	sizeof(struct RANAP_RANAP_EnhancedRelocationInformationResponse__ranaP_EnhancedRelocationInformationResponse_ies),
	offsetof(struct RANAP_RANAP_EnhancedRelocationInformationResponse__ranaP_EnhancedRelocationInformationResponse_ies, _asn_ctx),
