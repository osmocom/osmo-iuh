...
static asn_SET_OF_specifics_t asn_SPC_raB_SetupOrModifiedList_ies_specs_2 = {
	sizeof(struct RANAP_RAB_SetupOrModifiedList__raB_SetupOrModifiedList_ies),
	offsetof(struct RANAP_RAB_SetupOrModifiedList__raB_SetupOrModifiedList_ies, _asn_ctx),
