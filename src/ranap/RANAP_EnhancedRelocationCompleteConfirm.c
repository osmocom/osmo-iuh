...
static asn_SET_OF_specifics_t asn_SPC_enhancedRelocationCompleteConfirm_ies_specs_2 = {
	sizeof(struct RANAP_EnhancedRelocationCompleteConfirm__enhancedRelocationCompleteConfirm_ies),
	offsetof(struct RANAP_EnhancedRelocationCompleteConfirm__enhancedRelocationCompleteConfirm_ies, _asn_ctx),
