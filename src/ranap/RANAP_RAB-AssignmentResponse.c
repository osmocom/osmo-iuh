...
static asn_SET_OF_specifics_t asn_SPC_raB_AssignmentResponse_ies_specs_2 = {
	sizeof(struct RANAP_RAB_AssignmentResponse__raB_AssignmentResponse_ies),
	offsetof(struct RANAP_RAB_AssignmentResponse__raB_AssignmentResponse_ies, _asn_ctx),
