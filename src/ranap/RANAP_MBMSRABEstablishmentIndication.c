...
static asn_SET_OF_specifics_t asn_SPC_mbmsrabEstablishmentIndication_ies_specs_2 = {
	sizeof(struct RANAP_MBMSRABEstablishmentIndication__mbmsrabEstablishmentIndication_ies),
	offsetof(struct RANAP_MBMSRABEstablishmentIndication__mbmsrabEstablishmentIndication_ies, _asn_ctx),
