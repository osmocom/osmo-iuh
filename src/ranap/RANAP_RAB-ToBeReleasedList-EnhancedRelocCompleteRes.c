...
static asn_SET_OF_specifics_t asn_SPC_raB_ToBeReleasedList_EnhancedRelocCompleteRes_ies_specs_2 = {
	sizeof(struct RANAP_RAB_ToBeReleasedList_EnhancedRelocCompleteRes__raB_ToBeReleasedList_EnhancedRelocCompleteRes_ies),
	offsetof(struct RANAP_RAB_ToBeReleasedList_EnhancedRelocCompleteRes__raB_ToBeReleasedList_EnhancedRelocCompleteRes_ies, _asn_ctx),
