...
static asn_SET_OF_specifics_t asn_SPC_raB_RelocationReleaseList_ies_specs_2 = {
	sizeof(struct RANAP_RAB_RelocationReleaseList__raB_RelocationReleaseList_ies),
	offsetof(struct RANAP_RAB_RelocationReleaseList__raB_RelocationReleaseList_ies, _asn_ctx),
