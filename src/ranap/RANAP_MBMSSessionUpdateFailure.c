...
static asn_SET_OF_specifics_t asn_SPC_mbmsSessionUpdateFailure_ies_specs_2 = {
	sizeof(struct RANAP_MBMSSessionUpdateFailure__mbmsSessionUpdateFailure_ies),
	offsetof(struct RANAP_MBMSSessionUpdateFailure__mbmsSessionUpdateFailure_ies, _asn_ctx),
