...
static asn_SET_OF_specifics_t asn_SPC_ueRadioCapabilityMatchResponse_ies_specs_2 = {
	sizeof(struct RANAP_UeRadioCapabilityMatchResponse__ueRadioCapabilityMatchResponse_ies),
	offsetof(struct RANAP_UeRadioCapabilityMatchResponse__ueRadioCapabilityMatchResponse_ies, _asn_ctx),
