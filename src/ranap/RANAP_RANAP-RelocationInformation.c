...
static asn_SET_OF_specifics_t asn_SPC_ranaP_RelocationInformation_ies_specs_2 = {
	sizeof(struct RANAP_RANAP_RelocationInformation__ranaP_RelocationInformation_ies),
	offsetof(struct RANAP_RANAP_RelocationInformation__ranaP_RelocationInformation_ies, _asn_ctx),
