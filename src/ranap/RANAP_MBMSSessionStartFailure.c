...
static asn_SET_OF_specifics_t asn_SPC_mbmsSessionStartFailure_ies_specs_2 = {
	sizeof(struct RANAP_MBMSSessionStartFailure__mbmsSessionStartFailure_ies),
	offsetof(struct RANAP_MBMSSessionStartFailure__mbmsSessionStartFailure_ies, _asn_ctx),
