...
static asn_SET_OF_specifics_t asn_SPC_raB_DataVolumeReportList_ies_specs_2 = {
	sizeof(struct RANAP_RAB_DataVolumeReportList__raB_DataVolumeReportList_ies),
	offsetof(struct RANAP_RAB_DataVolumeReportList__raB_DataVolumeReportList_ies, _asn_ctx),
