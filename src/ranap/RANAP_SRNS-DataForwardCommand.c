...
static asn_SET_OF_specifics_t asn_SPC_srnS_DataForwardCommand_ies_specs_2 = {
	sizeof(struct RANAP_SRNS_DataForwardCommand__srnS_DataForwardCommand_ies),
	offsetof(struct RANAP_SRNS_DataForwardCommand__srnS_DataForwardCommand_ies, _asn_ctx),
