...
static asn_SET_OF_specifics_t asn_SPC_locationRelatedDataRequest_ies_specs_2 = {
	sizeof(struct RANAP_LocationRelatedDataRequest__locationRelatedDataRequest_ies),
	offsetof(struct RANAP_LocationRelatedDataRequest__locationRelatedDataRequest_ies, _asn_ctx),
