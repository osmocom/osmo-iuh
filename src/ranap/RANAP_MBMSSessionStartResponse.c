...
static asn_SET_OF_specifics_t asn_SPC_mbmsSessionStartResponse_ies_specs_2 = {
	sizeof(struct RANAP_MBMSSessionStartResponse__mbmsSessionStartResponse_ies),
	offsetof(struct RANAP_MBMSSessionStartResponse__mbmsSessionStartResponse_ies, _asn_ctx),
