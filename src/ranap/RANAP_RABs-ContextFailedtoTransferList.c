...
static asn_SET_OF_specifics_t asn_SPC_raBs_ContextFailedtoTransferList_ies_specs_2 = {
	sizeof(struct RANAP_RABs_ContextFailedtoTransferList__raBs_ContextFailedtoTransferList_ies),
	offsetof(struct RANAP_RABs_ContextFailedtoTransferList__raBs_ContextFailedtoTransferList_ies, _asn_ctx),
