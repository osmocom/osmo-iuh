...
static asn_SET_OF_specifics_t asn_SPC_mbmsRegistrationFailure_ies_specs_2 = {
	sizeof(struct RANAP_MBMSRegistrationFailure__mbmsRegistrationFailure_ies),
	offsetof(struct RANAP_MBMSRegistrationFailure__mbmsRegistrationFailure_ies, _asn_ctx),
