...
static asn_SET_OF_specifics_t asn_SPC_mbmscnDe_RegistrationRequest_ies_specs_2 = {
	sizeof(struct RANAP_MBMSCNDe_RegistrationRequest__mbmscnDe_RegistrationRequest_ies),
	offsetof(struct RANAP_MBMSCNDe_RegistrationRequest__mbmscnDe_RegistrationRequest_ies, _asn_ctx),
