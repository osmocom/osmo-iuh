...
static asn_SET_OF_specifics_t asn_SPC_locationRelatedDataResponse_ies_specs_2 = {
	sizeof(struct RANAP_LocationRelatedDataResponse__locationRelatedDataResponse_ies),
	offsetof(struct RANAP_LocationRelatedDataResponse__locationRelatedDataResponse_ies, _asn_ctx),
