...
static asn_SET_OF_specifics_t asn_SPC_relocationCancelAcknowledge_ies_specs_2 = {
	sizeof(struct RANAP_RelocationCancelAcknowledge__relocationCancelAcknowledge_ies),
	offsetof(struct RANAP_RelocationCancelAcknowledge__relocationCancelAcknowledge_ies, _asn_ctx),
