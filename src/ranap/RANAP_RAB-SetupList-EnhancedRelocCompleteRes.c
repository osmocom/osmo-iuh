...
static asn_SET_OF_specifics_t asn_SPC_raB_SetupList_EnhancedRelocCompleteRes_ies_specs_2 = {
	sizeof(struct RANAP_RAB_SetupList_EnhancedRelocCompleteRes__raB_SetupList_EnhancedRelocCompleteRes_ies),
	offsetof(struct RANAP_RAB_SetupList_EnhancedRelocCompleteRes__raB_SetupList_EnhancedRelocCompleteRes_ies, _asn_ctx),
