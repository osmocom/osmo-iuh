...
static asn_SET_OF_specifics_t asn_SPC_raB_SetupList_EnhancedRelocCompleteReq_ies_specs_2 = {
	sizeof(struct RANAP_RAB_SetupList_EnhancedRelocCompleteReq__raB_SetupList_EnhancedRelocCompleteReq_ies),
	offsetof(struct RANAP_RAB_SetupList_EnhancedRelocCompleteReq__raB_SetupList_EnhancedRelocCompleteReq_ies, _asn_ctx),
