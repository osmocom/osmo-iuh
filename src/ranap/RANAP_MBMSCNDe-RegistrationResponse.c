...
static asn_SET_OF_specifics_t asn_SPC_mbmscnDe_RegistrationResponse_ies_specs_2 = {
	sizeof(struct RANAP_MBMSCNDe_RegistrationResponse__mbmscnDe_RegistrationResponse_ies),
	offsetof(struct RANAP_MBMSCNDe_RegistrationResponse__mbmscnDe_RegistrationResponse_ies, _asn_ctx),
