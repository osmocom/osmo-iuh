...
static asn_SET_OF_specifics_t asn_SPC_raB_ContextList_RANAP_RelocInf_ies_specs_2 = {
	sizeof(struct RANAP_RAB_ContextList_RANAP_RelocInf__raB_ContextList_RANAP_RelocInf_ies),
	offsetof(struct RANAP_RAB_ContextList_RANAP_RelocInf__raB_ContextList_RANAP_RelocInf_ies, _asn_ctx),
