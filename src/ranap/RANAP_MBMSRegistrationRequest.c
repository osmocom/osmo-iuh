...
static asn_SET_OF_specifics_t asn_SPC_mbmsRegistrationRequest_ies_specs_2 = {
	sizeof(struct RANAP_MBMSRegistrationRequest__mbmsRegistrationRequest_ies),
	offsetof(struct RANAP_MBMSRegistrationRequest__mbmsRegistrationRequest_ies, _asn_ctx),
