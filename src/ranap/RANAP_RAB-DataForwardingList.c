...
static asn_SET_OF_specifics_t asn_SPC_raB_DataForwardingList_ies_specs_2 = {
	sizeof(struct RANAP_RAB_DataForwardingList__raB_DataForwardingList_ies),
	offsetof(struct RANAP_RAB_DataForwardingList__raB_DataForwardingList_ies, _asn_ctx),
