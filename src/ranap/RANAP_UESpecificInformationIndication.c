...
static asn_SET_OF_specifics_t asn_SPC_ueSpecificInformationIndication_ies_specs_2 = {
	sizeof(struct RANAP_UESpecificInformationIndication__ueSpecificInformationIndication_ies),
	offsetof(struct RANAP_UESpecificInformationIndication__ueSpecificInformationIndication_ies, _asn_ctx),
