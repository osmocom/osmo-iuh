...
static asn_SET_OF_specifics_t asn_SPC_raB_DataVolumeReportRequestList_ies_specs_2 = {
	sizeof(struct RANAP_RAB_DataVolumeReportRequestList__raB_DataVolumeReportRequestList_ies),
	offsetof(struct RANAP_RAB_DataVolumeReportRequestList__raB_DataVolumeReportRequestList_ies, _asn_ctx),
