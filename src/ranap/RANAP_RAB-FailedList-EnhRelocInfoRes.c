...
static asn_SET_OF_specifics_t asn_SPC_raB_FailedList_EnhRelocInfoRes_ies_specs_2 = {
	sizeof(struct RANAP_RAB_FailedList_EnhRelocInfoRes__raB_FailedList_EnhRelocInfoRes_ies),
	offsetof(struct RANAP_RAB_FailedList_EnhRelocInfoRes__raB_FailedList_EnhRelocInfoRes_ies, _asn_ctx),
