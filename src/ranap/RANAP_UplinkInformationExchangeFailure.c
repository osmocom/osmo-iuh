...
static asn_SET_OF_specifics_t asn_SPC_uplinkInformationExchangeFailure_ies_specs_2 = {
	sizeof(struct RANAP_UplinkInformationExchangeFailure__uplinkInformationExchangeFailure_ies),
	offsetof(struct RANAP_UplinkInformationExchangeFailure__uplinkInformationExchangeFailure_ies, _asn_ctx),
