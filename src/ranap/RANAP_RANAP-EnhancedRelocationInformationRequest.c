...
static asn_SET_OF_specifics_t asn_SPC_ranaP_EnhancedRelocationInformationRequest_ies_specs_2 = {
	sizeof(struct RANAP_RANAP_EnhancedRelocationInformationRequest__ranaP_EnhancedRelocationInformationRequest_ies),
	offsetof(struct RANAP_RANAP_EnhancedRelocationInformationRequest__ranaP_EnhancedRelocationInformationRequest_ies, _asn_ctx),
