...
static asn_SET_OF_specifics_t asn_SPC_resetResourceAcknowledge_ies_specs_2 = {
	sizeof(struct RANAP_ResetResourceAcknowledge__resetResourceAcknowledge_ies),
	offsetof(struct RANAP_ResetResourceAcknowledge__resetResourceAcknowledge_ies, _asn_ctx),
