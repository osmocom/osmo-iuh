...
static asn_SET_OF_specifics_t asn_SPC_ueRadioCapabilityMatchRequest_ies_specs_2 = {
	sizeof(struct RANAP_UeRadioCapabilityMatchRequest__ueRadioCapabilityMatchRequest_ies),
	offsetof(struct RANAP_UeRadioCapabilityMatchRequest__ueRadioCapabilityMatchRequest_ies, _asn_ctx),
