...
static asn_SET_OF_specifics_t asn_SPC_mbmsSessionStopResponse_ies_specs_2 = {
	sizeof(struct RANAP_MBMSSessionStopResponse__mbmsSessionStopResponse_ies),
	offsetof(struct RANAP_MBMSSessionStopResponse__mbmsSessionStopResponse_ies, _asn_ctx),
