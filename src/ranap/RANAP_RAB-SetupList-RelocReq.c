...
static asn_SET_OF_specifics_t asn_SPC_raB_SetupList_RelocReq_ies_specs_2 = {
	sizeof(struct RANAP_RAB_SetupList_RelocReq__raB_SetupList_RelocReq_ies),
	offsetof(struct RANAP_RAB_SetupList_RelocReq__raB_SetupList_RelocReq_ies, _asn_ctx),
