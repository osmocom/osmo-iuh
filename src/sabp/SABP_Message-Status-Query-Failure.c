...
static asn_SET_OF_specifics_t asn_SPC_message_Status_Query_Failure_ies_specs_2 = {
	sizeof(struct SABP_Message_Status_Query_Failure__message_Status_Query_Failure_ies),
	offsetof(struct SABP_Message_Status_Query_Failure__message_Status_Query_Failure_ies, _asn_ctx),
